...
const selfPath = require.resolve( '@megalo/regular-loader' )
...
module.exports.pitch = function (remainingRequest) {
  ...
  if (query.type === `template`) {
    ...
    // remove @megalo/regular-loader to disable select block, template need all
    const request = genRequest([
      ...cacheLoader,
      templateLoaderPath + `??regular-loader-options`,
      selectorLoaderPath + `??regular-loader-options`,
  ...
  // if a custom block has no other matching loader other than @megalo/regular-loader itself,
  // we should ignore it

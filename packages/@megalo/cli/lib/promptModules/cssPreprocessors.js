module.exports = cli => {
  cli.injectFeature({
    ...
    link: 'https://cli.megalojs.org/guide/css.html'
  })
  ...
  cli.injectPrompt({
    ...
    type: 'list',
    message: `Pick a CSS pre-processor${process.env.MEGALO_CLI_API_MODE ? '' : ` (${notice})`}:`,
    description: `${notice}.`,
    choices: [
      ...
      // In @megalo/cli-service there're still codes that accepts 'sass' as an option value, for compatibility reasons,

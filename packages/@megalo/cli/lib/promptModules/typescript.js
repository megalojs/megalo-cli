module.exports = cli => {
  cli.injectFeature({
    ...
    link: 'https://github.com/megalojs/megalo-cli/tree/dev/packages/%40megalo/cli-plugin-typescript',
    plugins: ['typescript']
  })
  ...
  //   link: 'https://megalojs.org/v2/guide/typescript.html#Class-Style-Megalo-Components',
  //   default: true
  // })
  ...
  cli.onPromptComplete((answers, options) => {
    if (answers.features.includes('ts')) {
      ...
      options.plugins['@megalo/cli-plugin-typescript'] = tsOptions
    }
  })
}

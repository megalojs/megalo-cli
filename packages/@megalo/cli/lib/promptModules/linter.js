module.exports = cli => {
  ...
  const { hasGit } = require('@megalo/cli-share-utils')
  ...
  cli.injectFeature({
    ...
    link: 'https://github.com/megalojs/megalo-cli/tree/dev/packages/%40megalo/cli-plugin-eslint',
    plugins: ['eslint'],
    checked: true
  })
  ...
  cli.onPromptComplete((answers, options) => {
    ...
    if (answers.features.includes('linter')) {
      options.plugins['@megalo/cli-plugin-eslint'] = {
